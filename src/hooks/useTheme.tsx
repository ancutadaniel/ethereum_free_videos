...
const useTheme = () => {
    ...
    const themeIcon = theme === 'light' ? (
        ...
        strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" height="30px" width="30px">
        ...
        stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" height="30px" width="30px">
